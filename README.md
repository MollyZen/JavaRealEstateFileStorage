...
Simple website that allows storing and downloading files related to real estate using Java 17, Apache Tomcat 10 and MySQL. The site also utilizes OpenStreetMap, OpenLayers, Yandex.Geocoder and Russian Open Access Cadastre map for functionality of displaying actual location of real estate along with pulling addresses and cadaste identifiers. 
